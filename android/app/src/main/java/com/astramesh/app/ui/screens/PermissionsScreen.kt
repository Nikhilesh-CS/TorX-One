...
fun PermissionsScreen(onRetry: () -> Unit) {
    ...
    Box(
        ...
        Column(
            ...
            Text(
                "Astra Mesh needs Notifications to alert you when messages arrive, and Bluetooth/Nearby permissions to discover devices and form mesh networks without central servers.",
