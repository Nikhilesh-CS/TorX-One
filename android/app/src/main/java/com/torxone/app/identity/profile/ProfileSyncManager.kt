...
class ProfileSyncManager(
    ...
    suspend fun broadcastLocalProfileToAll() {
        ...
        val contacts = com.torxone.app.service.TorXOneService.getInstance()?.db?.contactDao()?.getAllContactsSync() ?: return
    ...
    private fun updateContactName(senderKey: String, name: String) {
        ...
        val service = com.torxone.app.service.TorXOneService.getInstance() ?: return
